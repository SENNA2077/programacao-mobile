  ...
  return (
    <View style={styles.container}>
      <View style={styles.profileSection}>
        ...
        <View>
          <Text style={styles.profileName}>Talison Senna</Text>
          <Text style={styles.profileRole}>Desenvolvedor pior que o Junior</Text>
        </View>
      </View>
      <Text style={styles.sectionTitle}>Habilidades que não tem</Text>
